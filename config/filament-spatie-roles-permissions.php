...
return [
    ...
    'resources' => [
        ...
        'PermissionResource' => App\Filament\Resources\Permissions\PermissionResource::class,
        // 'RoleResource' => RoleResource::class,
        'RoleResource' => App\Filament\Resources\Roles\RoleResource::class,
    ],
